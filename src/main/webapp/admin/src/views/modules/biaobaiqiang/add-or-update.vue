<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="帖子标题" prop="tiezibiaoti">
          <el-input v-model="ruleForm.tiezibiaoti" 
              placeholder="帖子标题" clearable  :readonly="ro.tiezibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="帖子标题" prop="tiezibiaoti">
              <el-input v-model="ruleForm.tiezibiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发帖时间" prop="fatieshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fatieshijian" label="发帖时间" prop="fatieshijian">
              <el-input v-model="ruleForm.fatieshijian" 
                placeholder="发帖时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.fatieshijian = this.getCurDateTime()
  ...
  methods: {
	...
	this.ruleForm.tiezineirong = this.ruleForm.tiezineirong.replace(reg,'../../../ssm84s2a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `biaobaiqiang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.biaobaiqiangCrossAddOrUpdateFlag = false;
						 this.parent.search();
