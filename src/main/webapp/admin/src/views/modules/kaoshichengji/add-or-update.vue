  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="学号" prop="id">
          <!--<el-input v-model="ruleForm.xuehao"
              placeholder="学号" clearable  :readonly="ro.xuehao"></el-input>-->
          <el-input v-model="ruleForm.id"
                    placeholder="学号" clearable  :readonly="ro.id"></el-input>
        </el-form-item>
        <div v-else>
          <!--<el-form-item class="input" label="学号" prop="xuehao">-->
          <el-form-item class="input" label="学号" prop="id">
              <!--<el-input v-model="ruleForm.xuehao"-->
            <el-input v-model="ruleForm.id"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生姓名" prop="xueshengxingming">
          ...
          <el-input v-model="ruleForm.room"
                    placeholder="学生姓名" clearable  :readonly="ro.room"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="学生姓名" prop="room">
            <el-input v-model="ruleForm.room"
                      placeholder="学生姓名" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="试题名称" prop="shitimingcheng">
          <el-input v-model="ruleForm.shitimingcheng"
              placeholder="试题名称" clearable  :readonly="ro.shitimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="试题名称" prop="shitimingcheng">
              <el-input v-model="ruleForm.shitimingcheng"
       ...
       this.$refs["ruleForm"].validate(valid => {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
			 ...
			 this.$http({
			   url: `classroom/${!this.ruleForm.id ? "save" : "update"}`,
			   method: "post",
			   data: this.ruleForm
			 }).then(({ data }) => {
			   if (data && data.code === 0) {
