                ...
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '订单编号' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.orderid" placeholder="订单编号"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.orderid" placeholder="订单编号"
                                  clearable></el-input>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '商品名称' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="商品名称"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="商品名称"
                                  clearable></el-input>
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        ...
                        <download-excel  class="export-excel-wrapper"
                                        :data="dataList" :fields="json_fields" name="订单.xls" >
                            <!-- 导出excel -->
                            <!--v-if="contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1"-->
                            <el-button
                                    type="danger"
                                    icon="el-icon-download" @click="handleExportTemplate()"
                            >{{ contents.btnAdAllFont == 1?'导入模板':'' }}
                            </el-button>
                            <!--<el-button v-if="contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2" type="danger">
                                {{ contents.btnAdAllFont == 1?'导出':'' }}<i class="el-icon-download el-icon&#45;&#45;right"/>
                            </el-button>-->
                        ...
                        <el-button
                                ...
                                type="warning"
                                @click="goodnameNumberChartDialog()"
                        >{{ contents.btnAdAllFont == 1?'商品销量':'' }}<i class="el-icon-s-data el-icon--right"/>
                        </el-button>
                        <el-button
                        ...
                        <el-button
                                ...
                                type="warning"
                                @click="goodtypeNumberChartDialog()"
                        >{{ contents.btnAdAllFont == 1?'类型销量':'' }}<i class="el-icon-s-data el-icon--right"/>
                        </el-button>
                        <el-button
                        ...
                        <el-button
                                ...
                                type="warning"
                                @click="goodnameAmountChartDialog()"
                        >{{ contents.btnAdAllFont == 1?'商品销额':'' }}<i class="el-icon-s-data el-icon--right"/>
                        </el-button>
                        <el-button
                        ...
                        <el-button
                                ...
                                type="warning"
                                @click="goodtypeAmountChartDialog()"
                        >{{ contents.btnAdAllFont == 1?'类型销额':'' }}<i class="el-icon-s-data el-icon--right"/>
                        </el-button>
                        <el-button
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('orders'+'/'+orderStatus,'查看') && contents.tableBtnIcon == 0"
                                       type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{
                            ...
                            <el-button v-if=" isAuth('orders'+'/'+orderStatus,'修改') && contents.tableBtnIcon == 0"
                                       type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">{{
                            ...
                            <el-button
                                    ...
                                    type="primary" icon="el-icon-edit" size="mini"
                                    @click="logisticsUpdate(scope.row.id)">{{ contents.tableBtnFont == 1?'物流':'' }}
                            </el-button>
                            <el-button
                                ...
                                contents.tableBtnFont == 1?'物流':'' }}<i class="el-icon-edit el-icon--right"/>
                            </el-button>
                            <el-button v-if="isAuth('orders'+'/'+orderStatus,'物流') && contents.tableBtnIcon == 0"
                                       type="primary" size="mini" @click="logisticsUpdate(scope.row.id)">{{
                            ...
                            <el-button
                                ...
                                contents.tableBtnFont == 1?'发货':'' }}<i class="el-icon-edit el-icon--right"/>
                            </el-button>
                            <el-button v-if="isAuth('orders'+'/'+orderStatus,'发货') && contents.tableBtnIcon == 0"
                                       type="primary" size="mini" @click="updateHandler(scope.row)">{{
                                contents.tableBtnFont == 1?'发货':'' }}
                            </el-button>
                            ...
                            <el-button
                                ...
                                contents.tableBtnFont == 1?'确认收货':'' }}<i class="el-icon-edit el-icon--right"/>
                            </el-button>
                            <el-button v-if="isAuth('orders'+'/'+orderStatus,'确认收货') && contents.tableBtnIcon == 0"
                                       type="primary" size="mini" @click="updateHandler2(scope.row)">{{
                                contents.tableBtnFont == 1?'确认收货':'' }}
                            </el-button>
                            ...
                            <el-button v-if="isAuth('orders'+'/'+orderStatus,'删除') && contents.tableBtnIcon == 0"
                                       type="danger" size="mini" @click="deleteHandler(scope.row.id)">{{
...
<script>
    ...
    export default {
        data() {
            return {
                //导入
                fileUrl: '/kaoshichengji/uploadExcel', //上传文件的域名地址
                limitNum: 1, //文件上传个数限制
                fileList: [], //文件列表
                ...
                contents: {
                    ...
                    "pagePosition": "1",
                    "inputFontSize": "14px",
                    "inputBorderRadius": "160px",
                    "tableBtnDelFontColor": "rgba(98, 190, 84, 1)",
                    "tableBtnIconPosition": "1",
                    "searchBtnHeight": "40px",
                    "tableBgColor": "#f5f5f5",
                    "inputIconColor": "rgba(255, 255, 255, 1)",
                    "searchBtnBorderRadius": "160px",
                    "tableStripe": true,
                    "btnAdAllWarnFontColor": "rgba(98, 190, 84, 1)",
                    ...
                    "searchBtnBgColor": "rgba(98, 190, 84, 1)",
                    "inputTitleSize": "14px",
                    "btnAdAllBorderColor": "#DCDFE6",
                    "pageJumper": true,
                    "btnAdAllIconPosition": "1",
                    "searchBoxPosition": "2",
                    "tableBtnDetailFontColor": "rgba(98, 190, 84, 1)",
                    "tableBtnHeight": "40px",
                    "pagePager": true,
                    "searchBtnBorderColor": "rgba(78, 147, 67, 1)",
                    "tableHeaderFontColor": "rgba(255, 255, 255, 1)",
                    "inputTitle": "1",
                    "tableBtnBorderRadius": "4px",
                    "btnAdAllFont": "1",
                    "btnAdAllDelFontColor": "rgba(98, 190, 84, 1)",
                    "tableBtnIcon": "1",
                    "btnAdAllHeight": "40px",
                    ...
                    "pageEachNum": 10,
                    "tableHeaderBgColor": "rgba(98, 190, 84, 1)",
                    "inputTitleColor": "rgba(98, 190, 84, 1)",
                    ...
                    "inputBgColor": "rgba(98, 190, 84, 1)",
                    "pageStyle": false,
                    "pageTotal": true,
                    "btnAdAllAddFontColor": "rgba(98, 190, 84, 1)",
                    "tableBtnFont": "1",
                    "tableContentFontColor": "#606266",
                    "inputBorderColor": "rgba(78, 147, 67, 1)",
                    "tableShowHeader": true,
                    "tableHoverBgColor": "#f5f5f5",
                    "tableBtnFontSize": "14px",
                    "tableBtnBorderColor": "rgba(98, 190, 84, 1)",
                    "inputIconPosition": "2",
                    "tableBorder": true,
                    "btnAdAllBorderStyle": "solid",
                    "tableBtnBorderWidth": "5px 1px",
                    "tableStripeBgColor": "#F5F7FA",
                    "tableBtnEditFontColor": "rgba(98, 190, 84, 1)",
                    "tableAlign": "center"
                },
                layouts: '',
...
//监听订单表参数是否变化，从而调取接口
        ...
        methods: {
            ...
            handleExportTemplate() {
                this.$http({
                    url: "kaoshichengji/exportTemplate",
                    method: "get",
                    params: {},
                    responseType: "blob"
                    // }).then(({ data }) => {
