<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社长账号" prop="shezhangzhanghao">
          <el-input v-model="ruleForm.shezhangzhanghao" 
              placeholder="社长账号" clearable  :readonly="ro.shezhangzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社长账号" prop="shezhangzhanghao">
              <el-input v-model="ruleForm.shezhangzhanghao" 
                placeholder="社长账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.shezhangzhanghao!=''&&json.shezhangzhanghao){
	...
	this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../ssm84s2a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
