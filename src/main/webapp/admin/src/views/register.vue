      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			   <div class="label">社长账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shezhangzhanghao" class="input" type="text" placeholder="社长账号">
			   </div>
			 </div> -->
			<el-form-item label="社长账号" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.shezhangzhanghao" autocomplete="off" placeholder="社长账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="社团名称" class="input" v-if="tableName=='shezhang'">
