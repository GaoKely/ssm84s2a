	...
	<view class="content my-publish-pv">
		<form>
			...
			<view class="cu-form-group">
				...
				<textarea :style='{"padding":"20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"rgba(255, 255, 255, 1)","color":"#333","borderRadius":"20rpx","borderWidth":"0","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"240rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 0px rgba(0,0,0,0) inset","margin":"20rpx 0","borderColor":"#409EFF","backgroundColor":"rgba(123, 226, 205, 1)","color":"#fff","borderRadius":"88rpx","borderWidth":"0","width":"50%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
		...
		async onLoad(options) {
			...
			this.ruleForm.userid = uni.getStorageSync("userid")
                ...
                this.ruleForm.username = this.user.jiaoshigonghao
                                                                                                                                                                                                						            						                                    ...
                                                                                                                                                                                                						            						                                    if(table == `shezhang`){
                this.ruleForm.username = this.user.shezhangzhanghao
            }
                                                                                                                                                                                                                                                						            			            			            			            			            			            			            			            			            			            			            			            			            			            			            			            			this.styleChange()
		},
		methods: {
